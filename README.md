...
_need support? Email [ggirl@jnolis.com](mailto:ggirl@jnolis.com)_
...
The mediums in this package that you can choose from will change over time. Currently available are [ggwatercolor()](#ggwatercolor), [ggartprint()](#ggartprint), and [ggpostcard()](#ggpostcard). This package can only mail physical items to addresses in the United States.
